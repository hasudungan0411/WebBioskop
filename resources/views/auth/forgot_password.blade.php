    ...
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <div class="w-full bg-gray-300 rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-5 sm:p-10">
                <div class="flex items-center mb-5 text-5xl font-semibold text-gray-900 dark:text-white">
                    ...
                    <form class="space-y-4 md:space-y-6" method="post" action="{{ route('reset_password.save') }}">
                        @csrf
                        @if ($errors->any())
                        ...
                        <a href="{{ route('login') }}" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Have you remembered your password? Login here</a>
                        </p>
                    </form>
                </div>
            </div>
